...
For monthly precipitation data like Mexico City 2028:
```json
...
**IMPORTANT:** Pass the entire JSON as a SINGLE STRING to the plot_config parameter. Do NOT split it across multiple parameters.
...
**Breakdown:**
- 🔍 **Data Accuracy:** [X]% - [Brief note on data quality]
- 🧪 **Scientific Explanation:** [X]% - [Brief note on scientific basis]
- 🖥️ **Model Information:** [X]% - [Brief note on SPEAR knowledge]
